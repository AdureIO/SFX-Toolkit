...
export class DevActionsProvider implements vscode.TreeDataProvider<vscode.TreeItem> {
  ...
  getChildren(element?: vscode.TreeItem): vscode.ProviderResult<vscode.TreeItem[]> {
    ...
    return [
      ...
      this.createItem(
        "SOQL Builder & Editor",
        "adure-sfx-toolkit.openSOQLEditor",
        "database",
        "Build and run SOQL queries"
      ),
      this.createItem(
        "Apex Snippets",
        "adure-sfx-toolkit.showSnippets",
        "play",
        "Run, add, edit or delete Apex snippets"
      ),
      this.createItem(
        "Apex Snippets Overview",
        "adure-sfx-toolkit.openSnippetsPanel",
        "list-unordered",
        "Open panel with all snippets"
      ),
      this.createItem(
        "Compare with Org",
        "adure-sfx-toolkit.metadataDiff",
        "diff",
        "Compare local file against org version"
      ),
