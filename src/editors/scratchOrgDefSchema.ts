...
export const ALL_FEATURES = [
  ...
  {
    name: "AddCustomApps",
    description: "Increase custom apps (1-30)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 30
  ...
  {
    name: "AddCustomObjects",
    description: "Increase custom objects (1-30)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 30
  ...
  {
    name: "AddCustomRelationships",
    description: "Increase custom relationships (1-10)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 10
  ...
  {
    name: "AddCustomTabs",
    description: "Increase custom tabs (1-30)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 30
  ...
  {
    name: "AddDataComCRMRecordCredit",
    description: "Increase Data.com record import credits (1-30)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 30
  ...
  {
    name: "AddInsightsQueryLimit",
    description: "Increase CRM Analytics query size (1-30)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 30
  ...
  {
    name: "AdditionalFieldHistory",
    description: "Track more field history (1-40)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 40
  ...
  {
    name: "AssetScheduling",
    description: "Asset Scheduling license (1-10)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 10
  ...
  {
    name: "CalloutSizeMB",
    description: "Max Apex callout size (3-12 MB)",
    hasParams: true,
    paramType: "number",
    paramMin: 3,
    paramMax: 12
  ...
  {
    name: "ConcStreamingClients",
    description: "Concurrent streaming clients (20-4000)",
    hasParams: true,
    paramType: "number",
    paramMin: 20,
    paramMax: 4000
  ...
  {
    name: "ConsolePersistenceInterval",
    description: "Console save interval (0-500 min)",
    hasParams: true,
    paramType: "number",
    paramMin: 0,
    paramMax: 500
  ...
  {
    name: "EmpPublishRateLimit",
    description: "Platform event publish rate (1000-10000)",
    hasParams: true,
    paramType: "number",
    paramMin: 1000,
    paramMax: 10000
  ...
  {
    name: "EncryptionStatisticsInterval",
    description: "Encryption stats interval (sec)",
    hasParams: true,
    paramType: "number",
    paramMin: 0,
    paramMax: 604800
  ...
  {
    name: "EncryptionSyncInterval",
    description: "Encryption sync interval (sec)",
    hasParams: true,
    paramType: "number",
    paramMin: 0,
    paramMax: 604800
  ...
  {
    name: "FieldService",
    description: "Field Service license (1-25)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 25
  ...
  {
    name: "FieldServiceAppointmentAssistantUser",
    description: "Appointment Assistant PSL (1-25)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 25
  ...
  {
    name: "FieldServiceDispatcherUser",
    description: "Dispatcher PSL (1-25)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 25
  ...
  {
    name: "FieldServiceLastMileUser",
    description: "Last Mile PSL (1-25)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 25
  ...
  {
    name: "FieldServiceMobileUser",
    description: "Mobile PSL (1-25)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 25
  ...
  {
    name: "FieldServiceSchedulingUser",
    description: "Scheduling PSL (1-25)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 25
  ...
  {
    name: "FinancialServicesCommunityUser",
    description: "FSC Insurance Community (1-10)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 10
  ...
  {
    name: "FinancialServicesUser",
    description: "FSC Standard PSL (1-10)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 10
  ...
  {
    name: "GenStreamingEventsPerDay",
    description: "Generic streaming events (10k-50k)",
    hasParams: true,
    paramType: "number",
    paramMin: 10000,
    paramMax: 50000
  ...
  {
    name: "HoursBetweenCoverageJob",
    description: "Sharing coverage report (1-24 hours)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 24
  ...
  {
    name: "LoyaltyMaximumPartners",
    description: "Max loyalty partners (0-1)",
    hasParams: true,
    paramType: "number",
    paramMin: 0,
    paramMax: 1
  ...
  {
    name: "LoyaltyMaximumPrograms",
    description: "Max loyalty programs (0-1)",
    hasParams: true,
    paramType: "number",
    paramMin: 0,
    paramMax: 1
  ...
  {
    name: "LoyaltyMaxOrderLinePerHour",
    description: "Max order lines/hour (1-3.5M)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 3500000
  ...
  {
    name: "LoyaltyMaxProcExecPerHour",
    description: "Max TJ processed/hour (1-500k)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 500000
  ...
  {
    name: "LoyaltyMaxTransactions",
    description: "Max TJ records (1-50M)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 50000000
  ...
  {
    name: "LoyaltyMaxTrxnJournals",
    description: "Max TJ stored (1-25M)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 25000000
  ...
  {
    name: "MaxActiveDPEDefs",
    description: "Active DPE definitions (1-50)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 50
  ...
  {
    name: "MaxApexCodeSize",
    description: "Max Apex code size (MB)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 100
  ...
  {
    name: "MaxCustomLabels",
    description: "Custom labels in thousands (1-15)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 15
  ...
  {
    name: "MaxDatasetLinksPerDT",
    description: "Dataset links per DT (1-3)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 3
  ...
  {
    name: "MaxDataSourcesPerDPE",
    description: "Source nodes per DPE (1-50)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 50
  ...
  {
    name: "MaxDecisionTableAllowed",
    description: "Decision tables (1-30)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 30
  ...
  {
    name: "MaxFavoritesAllowed",
    description: "User favorites (0-200)",
    hasParams: true,
    paramType: "number",
    paramMin: 0,
    paramMax: 200
  ...
  {
    name: "MaxFieldsPerNode",
    description: "Fields per DPE node (1-500)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 500
  ...
  {
    name: "MaxInputColumnsPerDT",
    description: "Input fields per DT (1-10)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 10
  ...
  {
    name: "MaxLoyaltyProcessRules",
    description: "Loyalty process rules (1-20)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 20
  ...
  {
    name: "MaxNodesPerDPE",
    description: "Nodes per DPE (1-500)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 500
  ...
  {
    name: "MaxNoOfLexThemesAllowed",
    description: "Lightning themes (0-300)",
    hasParams: true,
    paramType: "number",
    paramMin: 0,
    paramMax: 300
  ...
  {
    name: "MaxOutputColumnsPerDT",
    description: "Output fields per DT (1-5)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 5
  ...
  {
    name: "MaxSourceObjectPerDSL",
    description: "Source objects per dataset link (1-5)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 5
  ...
  {
    name: "MaxStreamingTopics",
    description: "PushTopic events/day (40-100)",
    hasParams: true,
    paramType: "number",
    paramMin: 40,
    paramMax: 100
  ...
  {
    name: "MaxUserNavItemsAllowed",
    description: "Nav bar items (0-500)",
    hasParams: true,
    paramType: "number",
    paramMin: 0,
    paramMax: 500
  ...
  {
    name: "MaxUserStreamingChannels",
    description: "User streaming channels (20-1000)",
    hasParams: true,
    paramType: "number",
    paramMin: 20,
    paramMax: 1000
  ...
  {
    name: "MaxWritebacksPerDPE",
    description: "Writeback nodes per DPE (1-50)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 50
  ...
  {
    name: "MedVisDescriptorLimit",
    description: "Sharing definitions (150-1600)",
    hasParams: true,
    paramType: "number",
    paramMin: 150,
    paramMax: 1600
  ...
  {
    name: "MobileExtMaxFileSizeMB",
    description: "FS Mobile ext file size (1-2000 MB)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 2000
  ...
  {
    name: "NumPlatformEvents",
    description: "Platform event definitions (5-20)",
    hasParams: true,
    paramType: "number",
    paramMin: 5,
    paramMax: 20
  ...
  { name: "PlatformCache", description: "Platform Cache (3 MB)", hasParams: false },
  {
    ...
    description: "Salesforce Connect (1-5)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 5
  ...
  {
    name: "PlatformEventsPerDay",
    description: "Platform events/day (10k-50k)",
    hasParams: true,
    paramType: "number",
    paramMin: 10000,
    paramMax: 50000
  ...
  {
    name: "ServiceCloudVoicePartnerTelephony",
    description: "SCV Partner Telephony (1-50)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 50
  ...
  {
    name: "StreamingEventsPerDay",
    description: "Streaming events/day v36 (10k-50k)",
    hasParams: true,
    paramType: "number",
    paramMin: 10000,
    paramMax: 50000
  ...
  {
    name: "SubPerStreamingChannel",
    description: "Subscribers per channel v36 (20-4000)",
    hasParams: true,
    paramType: "number",
    paramMin: 20,
    paramMax: 4000
  ...
  {
    name: "SubPerStreamingTopic",
    description: "Subscribers per topic v36 (20-4000)",
    hasParams: true,
    paramType: "number",
    paramMin: 20,
    paramMax: 4000
  ...
  {
    name: "WaveMaxCurrency",
    description: "CRM Analytics currencies (1-5)",
    hasParams: true,
    paramType: "number",
    paramMin: 1,
    paramMax: 5
