...
export async function lwcGoToJs() { await lwcGoToExt('.js'); }
export async function lwcGoToHtml() { await lwcGoToExt('.html'); }
export async function lwcGoToMeta() { await lwcGoToExt('.js-meta.xml'); }
export async function lwcGoToCss() { await lwcGoToExt('.css'); }
